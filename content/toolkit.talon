...
toolkit history$: user.hud_toolkit_history()
toolkit microphones$: user.show_microphone_options()
toolkit documentation$: user.hud_show_documentation()
toolkit walk throughs: user.hud_show_walkthroughs()
toolkit focus [show]: user.hud_add_focus_toggle()
toolkit focus hide: user.hud_remove_focus_toggle()